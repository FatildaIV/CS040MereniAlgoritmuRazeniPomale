...
namespace CS031MereniAlgoritmuProhozeni
{
    public partial class MereniAlgoritmuProhozeniForm : Form
    {
        ...
        {
            MeritSort(BubbleSort,1000, min, max);
            
            //VytizitProcesor();
            WriteLine("Počet položek;Bubble Sort;Selection Sort;Insertion Sort;Insertion Sort2; Insertion Sort3");
            for (int i = 10; i < maxPocet; i *= 2)
            {
                WriteLine(
                    string.Format(
                        "{0};{1:0.000000};{2:0.000000};{3:0.000000};{4:0.000000}; {5:0.000000}",
                        i,
                        MeritSort(BubbleSort, i, min, max),
                        MeritSort(SelectionSort, i, min, max),
                        MeritSort(InsertionSort, i, min, max),
                        MeritSort(InsertionSort2, i, min, max),
                        MeritSort(InsertionSort3, i, min, max)));
        }
        }
/*
        ...
        private double MeritInsertionSort2(int pocetPolozek)
        {
            int[] cisla = NewRandomArray(pocetPolozek, -20, 20);
            var sw = Stopwatch.StartNew();
        ...
        private double MeritInsertionSort3(int pocetPolozek)
        {
            int[] cisla = NewRandomArray(pocetPolozek, -20, 20);
            var sw = Stopwatch.StartNew();
            InsertionSort3(ref cisla, Razeni.Vzestupne);
            sw.Stop();
            return sw.Elapsed.TotalMilliseconds;
        }
*/
        ...
        private double MeritSort(AlgoritmusRazeni<int> algoritmus, int pocetPolozek, int min, int max)
        {
        ...
        private void meritRazeniButton_Click(object sender, EventArgs e)
        {
            ...
            InsertionSort3(ref cisla,Razeni.Vzestupne);
            WriteLine(string.Format("{0}, {1}", ToString(cisla), PoleRazeni(cisla)));
            InsertionSort3(ref cisla, Razeni.Sestupne);
            WriteLine(string.Format("{0}, {1}", ToString(cisla), PoleRazeni(cisla)));
            WriteLine();
